...
const Contact = () => {
  ...
  return (
    <main
      name="contact"
      id="contact"
      className="relative min-h-screen w-full overflow-x-hidden bg-[#030405] px-5 pb-20 pt-28 text-white md:px-10 md:pt-32"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto max-w-screen-xl">
        ...
        <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-[0.8fr_1.2fr]">
          <motion.aside
            {...reveal}
          ...
          >
            ...
            <h2 className="mt-4 font-teko text-4xl uppercase leading-none tracking-wide text-white md:text-5xl">
            ...
            <div className="mt-8 space-y-4">
              {contactLinks.map((item) => (
                ...
                >
                  ...
                  <span className="mt-2 block text-sm text-gray-200">
                    {item.value}
                  </span>
                </a>
              ))}
          ...
          >
            ...
            <button
              type="submit"
              className="mt-7 inline-flex min-h-11 w-fit items-center border border-white bg-white px-5 py-2 font-teko text-lg uppercase tracking-widest text-black transition hover:border-orange-300 hover:bg-orange-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-300 focus-visible:ring-offset-4 focus-visible:ring-offset-black"
            >
              Send message
            </button>
          </motion.form>
